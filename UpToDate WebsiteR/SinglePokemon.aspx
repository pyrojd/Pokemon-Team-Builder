...
<body>
    ...
    <div id="stats">
        ...
        <asp:dropdownlist class="stats" ID="Ability" runat="server"  Width="188px" DataSourceID="SqlDataSource2" DataTextField="Ability_Name" DataValueField="Ability_Name">
            <asp:ListItem>Select an Ability</asp:ListItem>
       </asp:dropdownlist> 
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:EnterpriseJDW35ConnectionString3 %>" SelectCommand="SELECT [Ability_Name] FROM [Ability]"></asp:SqlDataSource>
        <br />
        <asp:dropdownlist class="stats" ID="Item" runat="server"  Width="188px">
            <asp:ListItem>Select an Item</asp:ListItem>
       </asp:dropdownlist> <br />
        <asp:dropdownlist class="stats" ID="Attack1" runat="server"  Width="188px">
            <asp:ListItem>Select an Attack</asp:ListItem>
       </asp:dropdownlist> <br />
        <asp:dropdownlist class="stats" ID="Attack2" runat="server"  Width="188px">
            <asp:ListItem>Select a Second Attack</asp:ListItem>
       </asp:dropdownlist> <br />
        <asp:dropdownlist class="stats" ID="Attack3" runat="server"  Width="188px">
            <asp:ListItem>Select a Third Attack</asp:ListItem>
       </asp:dropdownlist> <br />
        <asp:dropdownlist class="stats" ID="Attack4" runat="server"  Width="188px">
            <asp:ListItem>Select a Forth Attack</asp:ListItem>
       </asp:dropdownlist> <br />
